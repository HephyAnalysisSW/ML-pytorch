...
selection = lambda ar: (ar.nrecoLep==1) 

feature_names = [   
            "parton_top1_decayAngle_theta", "parton_top1_decayAngle_phi", 
            #"parton_top2_decayAngle_theta", "parton_top2_decayAngle_phi", 
            "parton_top1_pt", "parton_top1_eta",  
            "parton_top1_f1_pt", "parton_top1_f1_eta", "parton_top1_f2_pt", "parton_top1_f2_eta", "parton_top1_b_pt", "parton_top1_b_eta", "parton_top1_W_pt", "parton_top1_W_eta", 
            #"parton_top2_f1_pt", "parton_top2_f1_eta", "parton_top2_f2_pt", "parton_top2_f2_eta", "parton_top2_b_pt", "parton_top2_b_eta", "parton_top2_W_pt", "parton_top2_W_eta", 
            "parton_top2_pt", "parton_top2_eta",  
            "parton_top2_f1_pt", "parton_top2_f1_eta", "parton_top2_f2_pt", "parton_top2_f2_eta", "parton_top2_b_pt", "parton_top2_b_eta", "parton_top2_W_pt", "parton_top2_W_eta", 
            ...
            "recoBj01_pt", "recoBj01_mass", "nBTag",
            "recoLep0_pt", "recoLep0_eta", "recoLep1_pt", "recoLep1_eta", "recoLepPos_pt", "recoLepPos_eta", "recoLepNeg_pt", "recoLepNeg_eta", #"recoLep01_pt", "recoLep01_mass",
    ]
observers = []

data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/postprocessed/gen/v2/TT01j1l_HT500/TT01j1l_HT500_*.root"],
        n_split = 1,
        splitting_strategy = "files",
        selection   = selection,
        branches = ["p_C", "nrecoLep"] +feature_names   ) 

reweight_pkl = '/eos/vbc/group/cms/robert.schoefbeck/gridpacks/CA/TT01j1lCA_HT500_reweight_card.pkl'
...
plot_options =  {
    ...
    "nBTag"           :{'binning':[4,0,4], 'tex':'N_b'},
    "recoLep0_pt"     :{'binning':[30,0,200], 'tex':'p_T(l_1)'},
    "recoLep0_eta"   :{'binning':[30,-3,3], 'tex':'#eta(l_1)'},
    "recoLep1_pt"   :{'binning':[30,0,200], 'tex':'p_T(l_2)'},
    "recoLep1_eta"   :{'binning':[30,-3,3], 'tex':'#eta(l_2)'},
    "recoLepPos_pt"   :{'binning':[30,0,200], 'tex':'p_T(l^{+})'},
    "recoLepPos_eta"   :{'binning':[30,-3,3], 'tex':'#eta(l^{+})'},
    "recoLepNeg_pt"   :{'binning':[30,0,200], 'tex':'p_T(l^{-})'},
    "recoLepNeg_eta"   :{'binning':[30,-3,3], 'tex':'#eta(l^{-})'},
    #"recoLep01_pt"   :{'binning':[30,0,200], 'tex':'p_T(ll)'},
    #"recoLep01_mass"   :{'binning':[30,0,200], 'tex':'M(ll)'},
    #"recoLep_dPhi"     :{'binning':[30,0,200], 'tex':'#Delta#phi(ll)'},
    #"recoLep_dEta"     :{'binning':[30,0,200], 'tex':'#Delta#eta(ll)'},
}
