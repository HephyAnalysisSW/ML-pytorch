...
selection = lambda ar: (ar.nrecoLep>=1) & (ar.delphesJet_dR_hadTop_maxq1q2b<0.8) & (ar.parton_hadTop_pt<1000) & (ar.parton_lepTop_b_pt<400) & (ar.delphesJet_SDsubjet0_deltaEta<float('inf')) & (ar.delphesJet_SDsubjet1_deltaEta<float('inf'))
...
feature_names = [   
    ...
    "delphesJet_pt", "delphesJet_eta", "delphesJet_nConstituents", 
...
observers = [ 
            ...
            "parton_hadTop_pt", "parton_hadTop_eta", "parton_hadTop_q1_pt", "parton_hadTop_q2_pt", "parton_hadTop_b_pt", "parton_hadTop_b_eta", "parton_hadTop_W_pt", "parton_hadTop_W_eta", 
...
data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/postprocessed/gen/v8/TT01jDebug/TT01jDebug_*.root"],
        ...
        selection   = selection,
        branches = [ "p_C", "nrecoLep", "recoLep_pt", "delphesJet_dR_hadTop_maxq1q2b", "nrecoJet", "nBTag",] + observers + feature_names ) 
