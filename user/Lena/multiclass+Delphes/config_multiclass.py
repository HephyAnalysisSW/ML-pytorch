...
lstm_jets_maxN        = 10
lstm_jetVars_delphes  = ['pt/F', 'eta/F', 'phi/F']
...
lstm_jetVarNames_delphes  = [x.split('/')[0] for x in lstm_jetVars_delphes]
...
# directory = "/eos/vbc/group/cms/cristina.giordano/tttt/training-ntuples-tttt-2l_v2/MVA-training/tttt_2l_trg-dilepVL-minDLmass20-offZ1-njet4p-btag3p-ht500/"
