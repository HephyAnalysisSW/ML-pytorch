...
if ($_GET['noplots']) {
    ...
    $other_exts = array('log.png', 'lin.pdf', 'lin.cxx', 'lin.eps', 'lin.root', 'lin.txt', 'log.pdf','log.gif', 'log.cxx', 'log.eps', 'log.root', 'log.txt');
    $filenames = glob("*lin.png"); 
    $used = array();
    foreach ($filenames as $filename) {
        ...
        print "<a href=\"$filename\"><img src=\"$filename\" style=\"border: none; width: 200px; \"></a>";
        $others = array();
    ...
    foreach ($filenames as $filename) {
        ...
        print "<div class='pic'>\n";
        print "<h3><a href=\"$filename\">$filename</a></h3>";
        print "<a href=\"$filename\"><img src=\"$filename\" style=\"border: none; width: 800px; \"></a>";
        $others = array();
        foreach ($other_exts as $ex) {
            $other_filename = str_replace('lin.gif', $ex, $filename);
