...
observers = ["parton_lepTop_phi", "parton_lepTop_lep_pt", "parton_lepTop_lep_eta", "parton_lepTop_lep_phi", "parton_lepTop_nu_pt", "parton_lepTop_nu_phi", "parton_lepTop_b_pt", "parton_lepTop_b_eta", "parton_lepTop_b_phi", "parton_lepTop_W_pt", "parton_lepTop_W_phi",
...
data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/predictions/ctGIm_truth2/TT01j_HT800_ext_comb/*.root"],
        n_split = 1,
