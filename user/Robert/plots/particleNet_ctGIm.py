...
predictions = [ "ctGIm_v2_best", ]  + ["ctGIm_v2_epoch_%i"%i for i in range(7)] + ["ctGRe_v2_epoch_%i"%i for i in range(7)] + ["ctWIm_v2_epoch_%i"%i for i in range(6)] + ["ctWRe_v2_epoch_%i"%i for i in range(7)]

data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/predictions/TT01jDebug-v2/*.root"],
        n_split = 1,
