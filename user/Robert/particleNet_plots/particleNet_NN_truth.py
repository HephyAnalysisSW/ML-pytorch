...
predictions =  ["ctGIm_truth_epoch_%i"%i for i in range(100)]

data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/predictions/ctGIm-truth-NN/TT01j_HT800_ext_comb/output_0.root"],
        n_split = 1,
