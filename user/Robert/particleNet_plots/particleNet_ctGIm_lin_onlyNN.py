...
predictions =  ["ctGIm_lin_epoch_%i"%i for i in range(0,300,10)] #forgot to remove th lin from the name

data_generator =  DataGenerator(
    input_files = ["/scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/predictions/ctGIm-lin-onlyNN/TT01j_HT800_ext_comb/output_*.root"],
        n_split = 1,
