...
plot_options =  {
    ...
    "tr_topBar_pt":{'binning':[50,0,1000], 'tex':'p_{T}(#bar{t})'},
    "tr_topBar_mass":{'binning':[50,0,2000], 'tex':'M(#bar{t})'},
    "tr_topBar_eta":{'binning':[30,-3,3], 'tex':'#eta(#bar{t})'},
    ...
    "tr_ttbar_mass"   :{'binning':[34,300,2000], 'tex':'M(t#bar{t})'},
    ...
    "tr_ttbar_dAbsEta"     :{'binning':[30,-2.5,2.5], 'tex':'#Delta|#eta|(t#bar{t})'},
    "tr_ttbar_dEta"       :{'binning':[30,-2.5,2.5], 'tex':'#Delta#eta(t#bar{t})'},
}
